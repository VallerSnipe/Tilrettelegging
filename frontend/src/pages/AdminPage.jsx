// frontend/src/pages/AdminPage.jsx (Oppdatert)
...
function AdminPage() {
    ...
    const handleImportSubmit = async () => {
        alert("Import-funksjonalitet via Electron er ikke fullt implementert ennå.");
        // Fremtidig logikk for å lese filen og sende innholdet via IPC
    };
            ...
            <section className="admin-section">
                ...
                <form onSubmit={handleAddSubmit}>
                    <div className="form-group">
                        ...
                        {/* ----- ENDRINGEN ER HER: onSelect er lagt til ----- */}
                        <AutocompleteSearch
